...
const DailyCheckIn: React.FC<DailyCheckInProps> = ({
  ...
  const allHealthSections: HealthSection[] = [
    {
      ...
      bgColor: "bg-pink-100",
      questions:
        metrics.find((m) => m.name.toLowerCase().includes("sexual"))
          ?.questions ||
    ...
    },
    {
      ...
      questions:
        metrics.find((m) => m.name.toLowerCase().includes("mental"))
          ?.questions ||
    ...
    },
    {
      ...
      bgColor: "bg-red-100",
      questions:
        metrics.find((m) => m.name.toLowerCase().includes("reproductive"))
          ?.questions ||
    ...
    },
    {
      ...
      bgColor: "bg-teal-100",
      questions:
        metrics.find((m) => m.name.toLowerCase().includes("social"))
          ?.questions ||
    ...
    },
    {
      ...
      bgColor: "bg-blue-100",
      questions:
        metrics.find((m) => m.name.toLowerCase().includes("physical"))
          ?.questions ||
  ...
  useEffect(() => {
    if (focusCategory) {
      const focusIndex = allHealthSections.findIndex(
        (section) => section.name === focusCategory,
      );
      if (focusIndex !== -1) {
  ...
  const totalPanels = Math.ceil(
    currentSection.questions.length / questionsPerPanel,
  );
  ...
  const handlePrevious = () => {
    if (currentPanelIndex > 0) {
      ...
      const prevTotalPanels = Math.ceil(
        prevSection.questions.length / questionsPerPanel,
      );
            ...
            <div className="space-y-2">
              ...
              <div className="px-4 py-6">
                <Slider
                  ...
                  onValueChange={(value) =>
                    handleQuestionResponse(question.id, value[0])
                  }
                  className="w-full"
                />
      ...
      <div className="w-80 bg-card border-r shadow-sm">
        ...
        <div className="p-4 border-t mt-auto">
          ...
          <div className="text-xs text-muted-foreground mt-1">
            {completedSections.size} of {healthSections.length} sections
            completed
          </div>
        </div>
      </div>
        ...
        <div className="flex-1 relative">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 border-t bg-card/95 backdrop-blur-sm shadow-lg">
            <div className="max-w-2xl mx-auto flex justify-between items-center">
              ...
              >
                {currentSectionIndex === healthSections.length - 1 &&
